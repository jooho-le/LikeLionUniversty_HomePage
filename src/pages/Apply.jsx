    ...
    <div className="apply-page">
        ...
        <div className="apply-hero-content">
          ...
          <div className="apply-track-grid">
            {tracks.map(({ icon: Icon, name, sub }) => (
              <article className="apply-track-card" key={name}>
      ...
      <section className="intro-section">
        ...
        <div className="apply-process">
          {process.map(({ step, title, desc, date }) => (
            <article className="apply-step" key={step}>
      ...
      <section className="intro-section">
        ...
        <div className="apply-faq-list">
          {faqs.map((item, index) => (
            <article className={`apply-faq-item${openFaq === index ? " open" : ""}`} key={item.q}>
              <button className="apply-faq-q" onClick={() => toggleFaq(index)} type="button">
                <span>{item.q}</span>
      ...
      <Link className={`apply-float-btn${showFloat ? " visible" : ""}`} to="/apply/form" aria-hidden={!showFloat}>
        지원하기
      </Link>
    </div>
  );
